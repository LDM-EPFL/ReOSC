...
- (id) _fastInit:(NSString *)addr
    hasWildCards:(BOOL)addrHasWildcards
           mType:(OSCMessageType)mType
           qType:(OSCQueryType)qType
         qTxAddr:(unsigned int)qTxAddr
         qTxPort:(unsigned short)qTxPort;
